"""
Lien : https://www.youtube.com/watch?v=fmmQZEsLJRg&list=PLh3I780jNsiSvpGtPucq4yusBXVt3SL2Q&index=20
Cours : Button in Python Data App - Plotly Dash

Documentation : https://dash-bootstrap-components.opensource.faculty.ai/docs/components/button/
Autre doc : https://www.dash-mantine-components.com/components/button

Icônes pour les boutons : https://icon-sets.iconify.design/
