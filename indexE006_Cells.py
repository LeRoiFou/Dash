"""
Lien : https://www.youtube.com/watch?v=CIlzvRSa3X8&list=PLh3I780jNsiSC7QJMQ46tHDYYnfhGEflf&index=6
Cours : DataTable Width of Columns and Cells -- Dash Plotly
...
# Autre instanciation d'une DF sous pandas
...
# Configuration de la page @ : datatable
...
#----------------------------------------------------------------
    ...
    # })
#----------------------------------------------------------------
# Pour les caractères supplémentaires, affichage des '...'
#----------------------------------------------------------------
    # style_data={
    #     'overflow': 'hidden',
...
#----------------------------------------------------------------
    ...
    # })
#----------------------------------------------------------------
# Horizontal scroll by Freezing left column : colonne figée
#----------------------------------------------------------------
